...
\texttt{PublikationsID} beschreibt eine ID, wobei hier das Format und die genaue Art der ID dem Benutzer \"uberlassen wird. Mit dem Attribut \texttt{Art} wird festgelegt, um welche standardisierte Form von ID es sich handelt. \texttt{Nummer} enth\"alt dann die eigentliche ID, welche das Dokument besitzt. Hier k\"onnen somit verschiedenste Systeme vom Benutzer frei verwendet werden, es w\"are zum Beispiel eine "`ISBN"' oder eine "`ISSN"' denkbar.
...
Die Datensammlung \texttt{Geografischer Standort} beinhaltet Attribute f\"ur die vier Koordinaten, welche bei der Navigation auf der Erde n\"otig sind und zwar \texttt{N Breitengrad}, \texttt{E L\"angengrad}, \texttt{S Breitengrad} und \texttt{W L\"angengrad}. Hierbei werden logischerweise zur Standortbeschreibung immer nur zwei ben\"oigt, was davon abh\"angig ist, auf welcher Erdseite der Punkt sich befindet. Zus\"atzlich gibt ein Attribut das Land beziehungsweise die L\"ander (\texttt{Countries}) und den Ort (\texttt{Bezeichnung}) an.
...
Förderbereich & Förderbereich & Forschungsvorhaben \\ \hline
...
Förderkennzeichen & Förderkennzeichen & Forschungsvorhaben \\ \hline
Unsichtbar & Unsichtbar & FADO-Metadaten \\ \hline
Ausblenden & Ausblenden & FADO-Metadaten \\ \hline
\end{tabular}
\caption{Mapping der FADO Attribute für Forschungsvorhaben}
...
Seite (von-bis) & ENTFÄLLT & ENTFÄLLT \\ \hline
...
Preis & ENTFÄLLT & ENTFÄLLT \\ \hline
Medium & Format & Technische Daten \\ \hline
Shoprelevant & ENTFÄLLT & ENTFÄLLT \\ \hline
Shoplink & ENTFÄLLT & ENTFÄLLT \\ \hline
...
\end{tabular}
\end{center}
\caption{Mapping der FADO Attribute für Berichte}
...
\hline
Alt: & Neu: & Klasse: \\ \hline
Gültigkeit & Gültigkeit / Gültigkeitszusatz & DRS-Metadaten \\ \hline
Titel & Titel & Beschreibung des Inhalts \\ \hline
...
Änderung & Änderung & Datum Rechtsvorschriften \\ \hline
Größe & Größe & Datei \\ \hline
...
Publisher & ENTFÄLLT & ENTFÄLLT \\ \hline
Year of Pblishing & ENTFÄLLT & ENTFÄLLT \\ \hline
ISBN & ENTFÄLLT & ENTFÄLLT \\ \hline
Conferenc & Thema & Beschreibung des Inhalts \\ \hline
Name & Titel & Beschreibung des Inhalts \\ \hline
Konferenz & ENTFÄLLT & ENTFÄLLT \\ \hline
Kapitel & ENTFÄLLT & ENTFÄLLT \\ \hline
Author & ENTFÄLLT & ENTFÄLLT \\ \hline
Dateityp & Format & Technische Daten \\ \hline
Titel & ENTFÄLLT & ENTFÄLLT \\ \hline
...
Schlüsselwörter & Schüsselwort / Free Keyword & Inspire \\ \hline
