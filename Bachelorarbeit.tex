...
\lstset{basicstyle=\fontsize{9}{11}\selectfont\ttfamily, breaklines=true, backgroundcolor=\color{codegray}, numbers=left, numberstyle=\tiny, tabsize=4, language=java, captionpos=b, showstringspaces=false}
...
\title{Konzept und prototypische Implementierung eines übergreifenden Dokumenten- und Medienmanagements als SOA-Anwendung}
...
\newcommand{\Titel}{Konzept und prototypische Implementierung eines übergreifenden Dokumenten- und Medienmanagements}
...
\include{Analyse}
\newpage
\include{Datenkonzept}
\newpage
\include{Technologievergleich}
\newpage
\include{Backend}
\newpage
\include{Frontend}
