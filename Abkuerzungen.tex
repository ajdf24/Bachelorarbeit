...
%   \acro{API}{\emph{Application Programming Interface}}
  ...
  \acro{DMS}{\emph{Dokumentenmanagementsysteme}}
  ...
  \acro{DCMI}{\emph{Dublin Core Metadata Initiative}}
  \acro{SEO}{\emph{search engine optimization}}
  \acro{Exif}{\emph{Exchangeable Image File Format}}
  \acro{RDF}{\emph{Resource Description Framework}}
  \acro{ICT-ENSURE}{\emph{Literature Information System in the Field of ICT for Environmental Sustainability}}
  \acro{ONIX}{\emph{Online Information Exchange}}
  \acro{GPL}{\emph{General Public License}}
  \acro{UI}{\emph{User Interface}}
  \acro{CMIS}{\emph{Content Management Interoperability Services}}
  \acro{}{\emph{}}
