...
Die Dateien k\"onnen beliebig benannt werden, m\"ussen jedoch das ISO-Sprachk\"urzel am Namensende enthalten. Eine deutsche \"Ubersetzung w\"urde dann zum Beispiel in der Datei \\\texttt{I18N\_de\_DE.properties} und eine US-Amerikanische unter \texttt{I18N\_en\_US.properties} zu finden sein. Alfresco nutzt die Übersetzungen dann automatisch anhand der eingestellten Systemsprache.
...
Dieses Problem \"au\ss{}ert sich auch, da ein \ac{FADO}-Urteil keine physische Datei besitzt. Ein Urteil ist im alten System einfach als Datenbankeintrag abgebildet, ohne dass jemals eine physische Datei besteht. Bisher wurde dies im neuen System damit gel\"o\ss{}t, dass einfach eine leere Textdatei angelegt wurde, welcher dann die entsprechenden Metadaten zugeordnet werden k\"onnen. Ein Änderung dieses Mechanismus würde einen tieferen Eingriff in Alfresco notwendig machen, der im Rahmen dieser Arbeit jedoch nicht angegangen wird.
